...
SETTINGS = {
    'ENV_TYPE': [
        ...
        ('BasicSnakePBRS', {'entry_point': 'gym_snakerl.envs:SingleSnake', 'potential_based_rewards' : True}),
        ('HungrySnake', {'dynamic_step_limit': 100, 'entry_point': 'gym_snakerl.envs:SingleSnake'}),
        ('HungrySnakePBRS', {'dynamic_step_limit': 100, 'entry_point': 'gym_snakerl.envs:SingleSnake', 'potential_based_rewards' : True}),
        ('BabySnake', {'die_on_eat' : True, 'entry_point': 'gym_snakerl.envs:SingleSnake'}),
        ('BabySnakePBRS', {'die_on_eat' : True, 'entry_point': 'gym_snakerl.envs:SingleSnake', 'potential_based_rewards' : True}),
        ...
        ('ObstacleBasicSnakePBRS', {'entry_point' : 'gym_snakerl.envs:SingleSnake', 'num_obstacles' : 8, 'potential_based_rewards' : True}),
        ...
        ('ObstacleHungrySnakePBRS', {'dynamic_step_limit' : 100, 'entry_point' : 'gym_snakerl.envs:SingleSnake', 'num_obstacles' : 8, 'potential_based_rewards' : True}), 
